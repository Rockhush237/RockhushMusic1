...
from Rockhush import Telegram, YouTube, app
from Rockhush.misc import SUDOERS, _boot_
from Rockhush.plugins.playlist import del_plist_msg
from Rockhush.plugins.sudoers import sudoers_list
from Rockhush.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from Rockhush.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAxkBAAEJ_jlk1zWwvaWPGgi0b4ZfjvAE0YH6awACFQwAAqxmQFb6yuEFGSx5RzAE")
